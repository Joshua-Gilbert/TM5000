...
void graph_display(void) {
    ...
    while (!done) {
            ...
            if (selected_trace >= 0 && g_traces[selected_trace].enabled) {
                ...
                if (g_traces[selected_trace].unit_type == UNIT_DB) {
                    ...
                    if (g_traces[selected_trace].x_scale != 0.0 && 
                        ...
                        float freq = (sample_num + g_traces[selected_trace].x_offset / g_traces[selected_trace].x_scale) * g_traces[selected_trace].x_scale;
                        if (freq >= 1e6) {
        ...
        if (kbhit()) {
            ...
            /* Handle extended keys (0 followed by scan code) */
            if (key == 0) {
